...
final class Day16Tests: XCTestCase {
    func test_part1_test() {
        XCTAssertEqual(Day16.solvePartOne(from: "D2FE28"), 6)
        XCTAssertEqual(Day16.solvePartOne(from: "8A004A801A8002F478"), 16)
        XCTAssertEqual(Day16.solvePartOne(from: "620080001611562C8802118E34"), 12)
        XCTAssertEqual(Day16.solvePartOne(from: "C0015000016115A2E0802F182340"), 23)
        XCTAssertEqual(Day16.solvePartOne(from: "A0016C880162017C3686B18A3D4780"), 31)
    }

    func test_part1_solution() {
        XCTAssertEqual(Day16.solvePartOne(from: solutionInput), 996)
    }

    func test_part2_test() {
        XCTAssertEqual(Day16.solvePartTwo(from: "C200B40A82"), 3)
        XCTAssertEqual(Day16.solvePartTwo(from: "04005AC33890"), 54)
        XCTAssertEqual(Day16.solvePartTwo(from: "880086C3E88112"), 7)
        XCTAssertEqual(Day16.solvePartTwo(from: "CE00C43D881120"), 9)
        XCTAssertEqual(Day16.solvePartTwo(from: "D8005AC2A8F0"), 1)
        XCTAssertEqual(Day16.solvePartTwo(from: "F600BC2D8F"), 0)
        XCTAssertEqual(Day16.solvePartTwo(from: "9C005AC2F8F0"), 0)
        XCTAssertEqual(Day16.solvePartTwo(from: "9C0141080250320F1802104A08"), 1)
    }

    func test_part2_solution() {
        XCTAssertEqual(Day16.solvePartTwo(from: solutionInput), 96257984154)
    }
}
